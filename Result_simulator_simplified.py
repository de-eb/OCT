...
=======
from tqdm import tqdm
>>>>>>> e131071881b5c17d01c6cfb990407f2d9b02e5c9
...
ax0 = fig.add_subplot(111, title='Resampling', xlabel='Wavelength [nm]', ylabel='Intensity [-]')
ax0.yaxis.set_major_formatter(ScalarFormatter(useMathText=True))
ax0.ticklabel_format(style="sci",  axis="y",scilimits=(0,0))
ax0_0, = ax0.plot(wl, itf, label='before')
ax0_1, = ax0.plot(wl_fix, re, label='after')
