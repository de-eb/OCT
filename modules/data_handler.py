...
def save_spectra_3d(wavelength, width, height, reference=None, spectra=None, memo=None, file_path=None):
    ...
    spectra : `3d-ndarray`
        Spectra, such as interference light. 
        The data obtained by spectra[i][j] is the result of measurement at a single point, the data obtained by spectra[i] is the result of measurement in the horizontal direction.
    file_path : `str`
        Where file is stored.
        If not specified, the file will be automatically numbered and saved in `data/`.
    memo : `str`
...
def output_datainfo(data):
    """Output information of data generated by save_spectra_3d function.

    Parameter
    ----------
    data : `numpy.lib.npyio.NpzFile`
        Data generated by save_spectra_3d function.
    """
    print('<data information>\ndate:{}\nmemo:{}\nwidth:{}mm/height:{}mm\n'
    .format(data['date'][0],data['memo'][0],data['width'][0],data['height'][0]))

def output_datainfo_calculated(data):
    """Output information of calcuated c-scan data.

    Parameter
    ----------
    data : `numpy.lib.npyio.NpzFile`
        Calculated C-scan data.
    """
    print('<data information>\ndate:{}\nmemo:{}\nresolution:{}\ndepth_max:{}mm\nn:{}\nwidth:{}mm/height:{}mm\n' 
    .format(data['date'][0],data['memo'][0],data['resolution'][0],data['depth_max'][0],data['n'][0],data['width'][0],data['height'][0]))
